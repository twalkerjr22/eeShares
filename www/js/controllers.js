angular.module('app.controllers', [])
    ...
    // This is the settings tab controller -TW
    // It containts the functions and variables for our settings tab -TW
...
function ($scope, $stateParams, buildingService, $ionicModal, $q, $rootScope, $state, $ionicPopup) {
            ...
            // logout function -- using firebase authentication doc to logout -TW
